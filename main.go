...
//    import _ "github.com/carlos-gi/gorm/dialects/mysql"
//    // import _ "github.com/carlos-gi/gorm/dialects/postgres"
//    // import _ "github.com/carlos-gi/gorm/dialects/sqlite"
//    // import _ "github.com/carlos-gi/gorm/dialects/mssql"
...
// Refer https://carlos-gi.github.io/gorm/development.html#callbacks
...
// Where return a new relation, filter records with given conditions, accepts `map`, `struct` or `string` as conditions, refer http://carlos-gi.github.io/gorm/crud.html#query
...
//     db.Joins("JOIN emails ON emails.user_id = users.id AND emails.email = ?", "carlos-gi@example.org").Find(&user)
...
// Refer https://carlos-gi.github.io/gorm/crud.html#scopes
...
// Unscoped return all record including deleted record, refer Soft Delete https://carlos-gi.github.io/gorm/crud.html#soft-delete
func (s *DB) Unscoped() *DB {
	return s.clone().search.unscoped().db
}

// Attrs initialize struct with argument if record not found with `FirstOrInit` https://carlos-gi.github.io/gorm/crud.html#firstorinit or `FirstOrCreate` https://carlos-gi.github.io/gorm/crud.html#firstorcreate
func (s *DB) Attrs(attrs ...interface{}) *DB {
	return s.clone().search.Attrs(attrs...).db
}

// Assign assign result with argument regardless it is found or not with `FirstOrInit` https://carlos-gi.github.io/gorm/crud.html#firstorinit or `FirstOrCreate` https://carlos-gi.github.io/gorm/crud.html#firstorcreate
...
// https://carlos-gi.github.io/gorm/crud.html#firstorinit
...
// https://carlos-gi.github.io/gorm/crud.html#firstorcreate
...
// Update update attributes with callbacks, refer: https://carlos-gi.github.io/gorm/crud.html#update
func (s *DB) Update(attrs ...interface{}) *DB {
	return s.Updates(toSearchableMap(attrs...), true)
}

// Updates update attributes with callbacks, refer: https://carlos-gi.github.io/gorm/crud.html#update
...
// UpdateColumn update attributes without callbacks, refer: https://carlos-gi.github.io/gorm/crud.html#update
func (s *DB) UpdateColumn(attrs ...interface{}) *DB {
	return s.UpdateColumns(toSearchableMap(attrs...))
}

// UpdateColumns update attributes without callbacks, refer: https://carlos-gi.github.io/gorm/crud.html#update
...
// Association start `Association Mode` to handler relations things easir in that mode, refer: https://carlos-gi.github.io/gorm/associations.html#association-mode
